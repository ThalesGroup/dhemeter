...
output_file="merge_time_interp_forecast.nc"
...
echo docker run -v $data_out_dir:/home/app/data/raw -v $data_out_dir:/home/app/data/out -v $data_tmp_dir:/home/app/data/tmp -v $logs_dir:/home/app/logs -v $config_dir:/home/app/config:ro -v $share_dir:/home/app/share --user $UID:$(id -g) agregateur-forecast-clean_and_merge --logs_file "/home/app/logs/CLEAN_AND_MERGE_FORECAST.log" --config_file "/home/app/share/config.json" --params_time "/home/app/config/params_time.json" --params_variables "/home/app/config/params_variables.json" --metaparams "/home/app/config/metaparams.json" --output_dir "/home/app/data/out" --input_dir "/home/app/data/raw" --output_file $output_file > $logs_dir/FORECAST_CLEAN_AND_MERGE_out.log 2> $logs_dir/FORECAST_CLEAN_AND_MERGE_err.log

docker run -v $data_out_dir:/home/app/data/raw -v $data_out_dir:/home/app/data/out -v $data_tmp_dir:/home/app/data/tmp -v $logs_dir:/home/app/logs -v $config_dir:/home/app/config:ro -v $share_dir:/home/app/share --user $UID:$(id -g) agregateur-forecast-clean_and_merge --logs_file "/home/app/logs/CLEAN_AND_MERGE_FORECAST.log" --config_file "/home/app/share/config.json" --params_time "/home/app/config/params_time.json" --params_variables "/home/app/config/params_variables.json" --metaparams "/home/app/config/metaparams.json" --output_dir "/home/app/data/out" --input_dir "/home/app/data/raw" --output_file $output_file > $logs_dir/FORECAST_CLEAN_AND_MERGE_out.log 2> $logs_dir/FORECAST_CLEAN_AND_MERGE_err.log

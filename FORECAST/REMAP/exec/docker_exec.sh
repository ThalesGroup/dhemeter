...
#echo "docker run -v $data_raw_dir:/data/raw -v $data_raw_dir:/data/out -v $data_tmp_dir:/data/tmp -v $logs_dir:/data/logs -v $config_dir:/data/config:ro -it agregateur-forecast-remap --logs_file "/data/logs/REMAP.log" --logs_params "/data/logs/$model.log" --input_dir "/data/raw" --output_dir "/data/out" --option $model > $logs_dir/REMAP_out.log 2> $logs_dir/REMAP_err.log"
